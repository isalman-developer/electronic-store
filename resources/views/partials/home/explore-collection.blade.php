                ...
                <div class="swiper-wrapper pb-8">
                    ...
                    <div class="swiper-slide">
                        <a href="#!" class="text-center p-4 card-animation d-block bg-light">
                            <img src="{{ asset('assets/images/product/product-img-1.jpg') }}" alt="product image"
                    ...
                    <div class="swiper-slide">
                        <a href="#!" class="text-center p-4 card-animation d-block bg-light">
                            <img src="{{ asset('assets/images/product/product-img-10.jpg') }}" alt="product image"
                                class="mb-3 img-fluid" />
                    ...
                    <div class="swiper-slide">
                        <a href="#!" class="text-center p-4 card-animation d-block bg-light">
                            <img src="{{ asset('assets/images/product/product-img-7.jpg') }}" alt="product image"
                                class="mb-3 img-fluid" />
                    ...
                    <div class="swiper-slide">
                        <a href="#!" class="text-center p-4 card-animation d-block bg-light">
                            <img src="{{ asset('assets/images/product/product-img-8.jpg') }}" alt="product image"
                                class="mb-3 img-fluid" />
