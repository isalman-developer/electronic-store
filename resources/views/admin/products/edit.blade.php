          ...
          <div class="card-body">
            <div class="row">
              <div class="col-lg-12 mb-3">
                ...
                <input type="text" id="product-title" name="title" required value="{{ $product->title }}" class="@error('title') is-invalid @enderror form-control" placeholder="Heater">
              ...
              <div class="col-lg-3 mb-3">
                ...
                <input type="text" id="brand-title" name="brand" required value="{{ $product->brand }}" class="@error('brand') is-invalid @enderror form-control" placeholder="Seco">
                {{ showValidationMessage($errors->first('brand')) }}
              </div>

              <div class="col-lg-3 mb-3">
                <label for="tag-number" class="form-label">Tag Number</label>
                <input type="text" id="tag-number" name="tag_number" required value="{{ $product->tag_number }}" class="@error('tag_number') is-invalid @enderror form-control" placeholder="HTR112">
                {{ showValidationMessage($errors->first('tag_number')) }}
              </div>

              <div class="col-lg-3 mb-3">
                <label for="price-id" class="form-label">Price (RS)</label>
                <input type="number" id="price-id" name="price" step="0.01" min="0" required class="@error('price') is-invalid @enderror form-control" placeholder="1250" value="{{ $product->price }}">
                {{ showValidationMessage($errors->first('price')) }}
              </div>

              <div class="col-lg-3 mb-3">
                <label for="product-weight" class="form-label">Weight (KG)</label>
                <input type="number" id="product-weight" name="weight" value="{{ $product->weight }}" class="@error('weight') is-invalid @enderror form-control" placeholder="2">
                {{ showValidationMessage($errors->first('weight')) }}
              </div>

              <div class="col-lg-3 mb-3">
                <label for="stock-id" class="form-label">Stock</label>
                <input type="number" id="stock-id" name="stock" step="0.01" min="0" value="{{ $product->stock }}" class="@error('stock') is-invalid @enderror form-control" placeholder="100">
              ...
              <div class="row mb-3">
                <div class="col-lg-3">
                  ...
                  <div class="d-flex flex-wrap gap-2" role="group" aria-label="Size selection">
                    ...
                    <input type="checkbox" class="btn-check" value="{{ $size->id }}" id="size-{{ strtolower($size->title) }}" name="sizes[]" @checked($product->sizes->contains($size->id))>
                ...
                <div class="col-9">
                  ...
                  <div class="d-flex flex-wrap gap-2" role="group" aria-label="Color selection">
                    ...
                    <input type="checkbox" class="btn-check" value="{{ $color->id }}" id="color-{{ strtolower($color->title) }}" name="colors[]" @checked($product->colors->contains($color->id))>

                    <label for="color-{{ strtolower($color->title) }}" class="btn btn-light avatar-m rounded d-flex justify-content-center align-items-center">
                      {{ $color->title }}&nbsp;
              ...
              <div class="col-12 mb-3">
                ...
                <textarea class="form-control bg-light-subtle @error('description') is-invalid @enderror" id="description" rows="7" placeholder="Type description" name="description">{{ $product->description }}</textarea>
            ...
            <div class="image-upload-container">
              <div class="upload-area" id="uploadArea">
                <div class="drop-zone">
                  ...
                  <input type="file" id="fileInput" name="images[]" class="file-input" accept="image/png,image/jpeg,image/gif,image/jpg" multiple />
                </div>
              </div>
              {{ showValidationMessage($errors->first('images')) }}
            ...
            <div class="row">
              <div class="col-lg-6">
                <div class="mb-3">
                  ...
                  <input type="text" id="meta-title" value="{{ $product->meta_title }}" class="@error('meta_title') is-invalid @enderror form-control" placeholder="Buy Heaters Online | Seco Store" name="meta_title">
              ...
              <div class="col-lg-6">
                <div class="mb-3">
                  ...
                  <input type="text" id="meta-keywords" name="meta_keywords" value="{{ $product->meta_keywords }}" class="@error('meta_keywords') is-invalid @enderror form-control" placeholder="heaters, heating systems, CoolHeat Store, buy seco heaters online">
              ...
              <div class="col-lg-12">
                <div class="mb-0">
                  ...
                  <textarea class="form-control bg-light-subtle" id="@error('meta_description') is-invalid @enderror meta-description" rows="4" placeholder="Shop top-quality heaters at Seco Store..." name="meta_description">{{ $product->meta_description }}</textarea>
