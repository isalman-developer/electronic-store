<div class="main-nav">
  ...
  <div class="scrollbar" data-simplebar>
    <ul class="navbar-nav" id="navbar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link menu-arrow {{ request()->is('admin/products/*/edit') || request()->is('admin/products/*') ? 'active' : '' }} " href="#sidebarProducts" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="sidebarProducts">
          <span class="nav-icon">
            <iconify-icon icon="solar:t-shirt-bold-duotone"></iconify-icon>
          </span>
          <span class="nav-text"> Products </span>
        </a>
        <div class="collapse {{ request()->is('admin/products/*/edit') || request()->is('admin/products/*') ? 'show' : '' }}" id="sidebarProducts">
      ...
      <li class="nav-item">
        <a class="nav-link menu-arrow {{ request()->is('admin/categories/*/edit') || request()->is('admin/categories/*') ? 'active' : '' }}" href="#sidebarCategory" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="sidebarCategory">
          <span class="nav-icon">
            <iconify-icon icon="solar:clipboard-list-bold-duotone"></iconify-icon>
          </span>
          <span class="nav-text"> Category </span>
        </a>
        <div class="collapse {{ request()->is('admin/categories/*/edit') || request()->is('admin/categories/*') ? 'show' : '' }}" id="sidebarCategory">
          <ul class="nav sub-navbar-nav">
            <li class="sub-nav-item">
      ...
      <li class="nav-item">
        ...
        <div class="collapse {{ request()->is('admin/sliders/*/edit') || request()->is('admin/sliders/*') ? 'show' : '' }}" id="sidebarSlider">
          <ul class="nav sub-navbar-nav">
            <li class="sub-nav-item">
