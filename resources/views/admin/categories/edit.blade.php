...
@section('toogle-button', 'Edit Category')
@push('page-style')
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" id="tag-number" class="form-control" placeholder="HTR112"
                                            name="tag_number" value="{{ $category->tag_number }}">
                                    </div>
                                </div>
                                <div class="col-lg-12">
                                    <div class="mb-0">
                                ...
                                <div class="col-lg-12">
                                    <div class="mb-0">
                                        ...
                                        <textarea class="form-control bg-light-subtle" id="meta-description" rows="4"
                                            placeholder="Shop top-quality heaters at Seco Store..." name="meta_description">{{ $category->meta_description }}</textarea>
