...
@section('toogle-button', 'Create Category')
@push('page-style')
            ...
            <div class="row">
              <div class="col-lg-6">
                <div class="mb-3">
                  ...
                  <input type="text" id="category-title" class="form-control" placeholder="Heater" name="title" required>
                </div>
              </div>
              ...
              <div class="col-lg-6">
                <div class="mb-3">
                  ...
                  <input type="text" id="tag-number" class="form-control" placeholder="HTR112" name="tag_number">
                </div>
              </div>
              <div class="col-lg-12">
                <div class="mb-0">
