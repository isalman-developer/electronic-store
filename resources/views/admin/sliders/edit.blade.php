...
@section('title', "Edit $slider->title Slider")
@section('toogle-button', 'Edit Slider')
          ...
          <div class="card-body">
            <div class="row">
              <div class="col-lg-6 mb-3">
                ...
                <input type="text" id="slider-title" class="form-control @error('title') is-invalid @enderror" placeholder="Heater" name="title" required value="{{ $slider->title }}">
              ...
              <div class="col-lg-6 mb-3">
                ...
                <select class="form-control @error('status') is-invalid @enderror" id="status" data-choices data-choices-groups data-placeholder="Select Status" name="status" required>
                  ...
                  <option value="0" @selected($slider->status == 0)>In Active</option>
                </select>
                {{ showValidationMessage($errors->first('status')) }}
              </div>
              <div class="col-lg-12 mb-3">
                <label for="redirect_link" class="form-label">Redirect Link</label>
                <input type="text" id="slider-redirect-link" class="form-control @error('redirect_link') is-invalid @enderror" placeholder="https://seco.com.pk/products" name="redirect_link" required value="{{ $slider->redirect_link }}">
                {{ showValidationMessage($errors->first('redirect_link')) }}
              </div>

              <div class="col-lg-12">
                <label for="description" class="form-label">Description</label>
                <textarea class="form-control @error('description') is-invalid @enderror bg-light-subtle" id="description" rows="7" placeholder="Type description" name="description">{{ $slider->description }}</textarea>
            ...
            <div class="image-upload-container">
              <div class="upload-area" id="uploadArea">
                <div class="drop-zone">
                  ...
                  <input type="file" id="fileInput" name="image" class="file-input" accept="image/png,image/jpeg,image/gif,image/jpg" />
                </div>
              </div>
