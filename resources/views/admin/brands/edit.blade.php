...
@section('title', "Edit $brand->title Brand")
@section('toogle-button', 'Edit Brand')
@push('page-style')
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" id="brand-title" class="form-control" placeholder="Heater"
                                            name="title" value="{{ $brand->title }}">
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <select class="form-control" id="crater" data-choices data-choices-groups
                                        data-placeholder="Select Crater" name="status" required>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-12">
                                    <div class="mb-0">
                                        ...
                                        <textarea class="form-control bg-light-subtle" id="meta-description" rows="4"
                                            placeholder="Shop top-quality heaters at Seco Store..." name="meta_description">{{ $brand->meta_description }}</textarea>
                            ...
                            <div class="image-upload-container">
                                <div class="upload-area" id="uploadArea">
                                    <div class="drop-zone">
                                        ...
                                        <p class="drop-text">
                                            Drop your images here, or <span class="browse-text">click to browse</span>
                                        </p>
                                        <p class="file-info">
