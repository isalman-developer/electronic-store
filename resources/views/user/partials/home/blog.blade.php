        ...
        <div class="row gy-4">
            ...
            <div class="col-lg-4 col-md-6">
                <article class="">
                    ...
                    <div class="mt-4">
                        <h3 class="fs-5"><a href="#!" class="text-inherit">The Sowden Collection</a>
                        </h3>
            ...
            <div class="col-lg-4 col-md-6">
                <article class="">
                    ...
                    <div class="mt-4">
                        <h3 class="fs-5"><a href="#!" class="text-inherit">Discover our Kitchen
                                Essentials</a></h3>
            ...
            <div class="col-lg-4 col-md-6">
                <article class="">
                    ...
                    <div class="mt-4">
                        <h3 class="fs-5"><a href="#!" class="text-inherit">Sustainable products</a>
                        </h3>
